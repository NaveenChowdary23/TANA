...
class RegionalBenfits extends StatefulWidget {
  const RegionalBenfits({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ClipRRect(
            borderRadius: const BorderRadius.vertical(bottom: Radius.circular(20)), // Adjust the radius as needed
            child: Container(
              color: const Color.fromARGB(255, 245, 109, 88), // Header background color
              child: Column(
                children: [
